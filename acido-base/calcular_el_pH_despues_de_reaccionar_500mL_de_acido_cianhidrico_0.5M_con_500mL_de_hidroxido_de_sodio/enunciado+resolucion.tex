\begin{frame}
    ...
    \textbf{
		\input{
			~/Documentos/docencia/repositorio/ejercicios/quimica_general-github/acido-base/calcular_el_pH_despues_de_reaccionar_500mL_de_acido_cianhidrico_0.5M_con_500mL_de_hidroxido_de_sodio/enunciado.tex
			}
	}
\end{frame}
...
\begin{frame}
    ...
    $$
        n(\ce{HCN}) = \SI{,5}{\mol\per\cancel\liter}\cdot\SI{,5}{\cancel\liter} = \SI{2,5e-1}{\mol}
    $$
    $$
        n(\ce{NaOH}) = \SI{,5}{\mol\per\cancel\liter}\cdot\SI{,5}{\cancel\liter} = \SI{2,5e-1}{\mol}
    $$
    \structure{Reacción de neutralización:} \ce{HCN(ac) + NaOH(ac) -> NaCN(ac) + H2O(l)}\\[.3cm]
    \visible<2->{
        Como $n(\ce{HCN}) = n(NaOH)$, como la reacción es \textbf{\underline{mol a mol}} y estamos en el \textbf{\underline{punto de equivalencia}}.
                }
    \visible<3->{
    ...
    \visible<4->{
        ...
        \begin{overprint}
            \onslide<4>
                $$
                    K_h(\ce{CN-}) = \frac{K_w}{K_a(\ce{HCN})} = \frac{[\ce{HCN}][\ce{OH-}]}{[\ce{CN-}]}
                $$
            \onslide<5>
                \structure{Despreciamos la disociación frente a la concentración inicial de sal conjugada:}
                    $$
                        K_h(\ce{CN-}) = \frac{K_w}{K_a(\ce{HCN})} = \frac{[\ce{HCN}][\ce{OH-}]}{[\ce{CN-}]_0}
                    $$
            \onslide<6>
            ...
            \onslide<10>
                    $$
                        -14 +pK_a(\ce{HCN}) + 2\cdot(14-pH) = -\log{[\ce{CN-}]_0}
                    $$
            \onslide<11>
                    $$
                        pK_a(\ce{HCN}) + 14 - 2\cdot pH = -\log{[\ce{CN-}]_0}
                    $$
            \onslide<12>
                    $$

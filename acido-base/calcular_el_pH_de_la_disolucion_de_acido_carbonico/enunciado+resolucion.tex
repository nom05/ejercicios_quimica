\begin{frame}
    ...
    \textbf{
		\input{
			~/Documentos/docencia/repositorio/ejercicios/quimica_general-github/acido-base/calcular_el_pH_de_la_disolucion_de_acido_carbonico/enunciado.tex
			}
		}
\end{frame}
...
\begin{frame}
    ...
    {\small \structure{\ce{H2CO3} es un \underline{ácido diprótico}}}
        ...
        \begin{overprint}
            \onslide<2-4>
                ...
                \visible<3-4>{
                    ...
                    $$
                        x^2 -\SI{4,3e-7}{}\cdot(\SI{,02}{}-x) = 0\Rightarrow x^2 -\SI{4,3e-7}{}x -\SI{8,6e-9}{} = 0\Rightarrow x= [\ce{H+}]_1 = \SI{9,29e-5}{\Molar}
                    $$
                            }
                \visible<4>{
                    {\small \structure{Resolver ecuación de 2"o grado con aproximación:}}
                    $$
                        x^2 -\SI{4,3e-7}{}\cdot(\underbrace{\SI{,02}{}-x}_{\approx\SI{,02}{}}) = 0\Rightarrow x^2 -\SI{8,6e-9}{} = 0\Rightarrow x=\SI{9,27e-5}{\Molar} = [\ce{H+}]
                    $$
                            }
            \onslide<5>
...
\begin{frame}
    \frametitle{\ejerciciocmd}
    \framesubtitle{Resolución (\rom{2}): [\ce{OH-}] y pH de disolución de \ce{Ba(OH)2*8H2O}}
...
\begin{frame}
    ...
    \visible<2->{
        $$
            [\ce{OH-}] = 10^{-(14-pH)}\Rightarrow[\ce{OH-}] = \SI{1,288e-3}{\Molar} = x
        $$
                }
    \visible<3->{
        \begin{center}
